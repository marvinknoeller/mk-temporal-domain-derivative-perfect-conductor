...
for ii = 1 : 3
    if ii == 1
        grid_folder = 'Example2Grids/grids';
        exact_file  = 'sawn_cube2.msh';
        iter = 14;
    elseif ii == 2
        grid_folder = 'Example2Grids/grids15';
        exact_file  = 'sawn_cube2.msh';
        iter = 12;
    else
        grid_folder = 'Example2Grids/grids30';
        exact_file  = 'sawn_cube2.msh';
        iter = 13;
    end
    ...
    cb.LineWidth = 2.5;
    exportgraphics(gcf,fullfile('plots',strcat('rec2',num2str(ii),'.png')),'Resolution',300)
    close all
end
%% ---------- local functions ----------
